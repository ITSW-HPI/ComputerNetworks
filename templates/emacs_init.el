(custom-set-variables
 ...
 '(org-beamer-environments-extra
   '(
     ...
     ("context_riscv" "T" "\\begin{context_riscv}" "\\end{context_riscv}")
     ("context_ripes" "T" "\\begin{context_ripes}" "\\end{context_ripes}")
     ("idea" "I" "\\begin{idea}%U" "\\end{idea}")
     ("requirement" "R" "\\begin{requirement}%U" "\\end{requirement}")
     ("observation" "O" "\\begin{observation}%U" "\\end{observation}")
     ("furtherreading" "L" "\\begin{furtherreading}%U" "\\end{furtherreading}")
     ))
 )
