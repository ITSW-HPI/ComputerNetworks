...
% medium Example: client -- router -- server


\begin{tikzpicture}[node distance=2cm]
  \label{page:routing:ip_mac:medium_example}
  \smallExample{Router} 
  \node [switch, right=of r1, label={[align=center]below:Switch B}] (swB) {};  
  \node [server, right=of swB, label={[align=center]below:Server}] (server) {};
  ...
  \node [above=1cm of r1.east, align=center] (r1_east_label) {IP: 7.8.9.1\\MAC: q:r };

  \draw [thick] (r1) -- (swB) (swB) -- (server); 
  
  \begin{scope}[every path/.append style={->, thick, hpiblue}]
  ...
  \begin{scope}[on background layer]
    ...
    \node [fill=hpiblue!10, fit=(r1.east)(swB)(server.west)] {}; 
  \end{scope}
