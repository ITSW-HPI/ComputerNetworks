...
\begin{tikzpicture}
  ...
  \begin{axis}
    ...
    \addplot [domain=0:1] expression { 1*sin(5*x) }; 
    \addplot [domain=1:2] expression { 1*sin(5*x + pi/2) }; 
    \addplot [domain=2:3] expression { 1*sin(5*x) }; 
    \addplot [domain=3:5] expression { 1*sin(5*x + pi/2) }; 
    \addplot [domain=5:7] expression { 1*sin(5*x + pi/2) }; 
    \addplot [domain=7:8] expression { 1*sin(5*x) }; 
    \addplot [domain=8:10] expression { 1*sin(5*x + pi/2) }; 
